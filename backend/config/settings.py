...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("POSTGRES_DB", "edtech"),
        "USER": os.environ.get("POSTGRES_USER", "edtech"),
        "PASSWORD": os.environ.get("POSTGRES_PASSWORD", "edtech_dev_password"),
...
# --- Object Storage (MinIO) — used starting from the documents/RAG phase ---
# Runs as a native binary on this machine, not via docker-compose (see README.md).
